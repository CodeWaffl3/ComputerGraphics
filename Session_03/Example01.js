...
*/
gl.uniform4f(u_FragColor, 1.0, 0.0, 0.0, 1.0);
canvas.onmousedown = function(ev){ click2(ev, gl, canvas, a_Position, u_FragColor); }
...
function click2(ev, gl, canvas, a_Position, u_FragColor) {
  ...
  let coords = {x, y};
  g_points2.push(coords);

  var counter = 0;
  var red = true;

  for (var i = 0; i < g_points2.length; i++) {
